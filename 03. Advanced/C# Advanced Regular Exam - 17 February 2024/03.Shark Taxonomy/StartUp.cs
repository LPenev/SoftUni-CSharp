namespace SharkTaxonomy
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Shark shark1 = new ( "Great White", 5, "Seals", "Open Ocean" );

            Shark shark2 = new ( "Hammerhead", 4, "Fish", "Tropical Waters" );

            Shark shark3 = new ( "Tiger", 4, "Turtles", "Coral Reefs" );
            ...
            //Shark oceanicWhitetip2 = new("Oceanic2", 3, "Fish", "Open Ocean");
